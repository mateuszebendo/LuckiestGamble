...
<my-c:textField id="aposta_direta" name="aposta_direta" type="number" label="Escolha um número para a Aposta Direta"/>
...
<my-c:dinamicSelect id="aposta_duzia" name="aposta_duzia" options="${rol:getDozens()}" label="Escolha uma Dúzia"/>
...
<my-c:dinamicSelect id="aposta_par_impar" name="aposta_par_impar" options='${["Par", "Impar"]}' label="Escolha Par/Ímpar"/>
