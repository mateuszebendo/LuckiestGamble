...
<my-l:_baseLayout pageTitle="Login" scriptFiles="${pageScripts}" styleFiles="${pageStyles}">
    <main id="login-container">
        ...
        <my-l:defaultForm endpoint="app/usuario/cadastro" method="post" title="Cadastro" formId="form-cadastro" message="${message}">
            <my-c:textField id="username" name="username" label="Usuário" type="text" placeholder="Digite seu usuário" inputClass="default-input"/>
            ...
            <my-c:submitButton text="Entrar" buttonId="btn-login" customClass="custom-btn button-secondary"/>
        </my-l:defaultForm>
    </main>
</my-l:_baseLayout>
